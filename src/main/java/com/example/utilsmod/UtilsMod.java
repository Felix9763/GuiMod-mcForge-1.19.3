...
public class UtilsMod
{
    ...
    public PoseStack stack = new PoseStack(){
        ...
        public void translate(double p_85838_, double p_85839_, double p_85840_) {
            super.translate(p_85838_, p_85839_, p_85840_);
        }

        @Override
        public void scale(float p_85842_, float p_85843_, float p_85844_) {
            super.scale(p_85842_, p_85843_, p_85844_);
        }
    };
    public UtilsMod()
    {
    ...
    public void render(RenderGuiOverlayEvent.Post event){
        int plrx = (int) Minecraft.getInstance().player.getX();
