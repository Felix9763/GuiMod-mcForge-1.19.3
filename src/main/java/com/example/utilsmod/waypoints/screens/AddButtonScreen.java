...
public class AddButtonScreen extends Screen {
    ...
    public Xeditbox xE = new Xeditbox(Minecraft.getInstance().font,this.width/2 ,this.height/2,20,20,Component.literal("XBox"));
    public Yeditbox yE = new Yeditbox(Minecraft.getInstance().font,10,100,20,20,Component.literal("YBox"));
    public Zeditbox zE = new Zeditbox(Minecraft.getInstance().font,10,100,20,20,Component.literal("ZBox"));
